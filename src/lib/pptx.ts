...
import { contain, pageGeom } from "./geometry";
...
export async function downloadPptx(book: BookState) {
  ...
  pptx.defineLayout({ name: "BOOK", width: wIn, height: hIn });
  pptx.layout = "BOOK";
